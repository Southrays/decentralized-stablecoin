...
contract DSCEngine is ReentrancyGuard {
    ...
    event RedeemedCollateral(
        address indexed redeemedFrom, address redeemedTo, address indexed collateralToken, uint256 indexed amount
    );
    ...
    /////     constructor     /////
    //////////////////////////////
    constructor(address[] memory _collateralTokens, address[] memory _priceFeeds, address _dscAddress) {
     ...
     * @param _amountDscToBurn The amount of DSC tokens to be minted.
     */
    function _burnDsc(address _onBehalfOf, address _dscFrom, uint256 _amountDscToBurn) private nonReentrant {
